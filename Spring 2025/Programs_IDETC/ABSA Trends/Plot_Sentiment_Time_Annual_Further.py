...
output_dir_without_ux = r"D:\OneDrive\Academic History\Research\NLP-Driven Sustainable Design_CoDesign Lab\Co-Design Lab\Databases_IDETC\ABSA Trends_Annual\Without UX"
output_dir_grouped = r"D:\OneDrive\Academic History\Research\NLP-Driven Sustainable Design_CoDesign Lab\Co-Design Lab\Databases_IDETC\ABSA Trends_Annual\Grouped"
...
def create_plots(df, output_dir, generate_individual=False):
    ...
    plt.title("Rate of Change of Total Reviews Over Time")
    plt.legend(loc="upper left", bbox_to_anchor=(1, 1))
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.title("Positive-Negative Ratio Over Time")
    plt.legend(loc="upper left", bbox_to_anchor=(1, 1))
    plt.grid(True)
    plt.tight_layout()
...
print(f"✅ All plots saved successfully in:\n- {output_dir_without_ux}\n- {output_dir_grouped}")
